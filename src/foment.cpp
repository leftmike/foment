...
FObjectType ObjectTypes[] =
{
    ...
    {FlonumTag, "flonum", 0, WriteNumber},
    {BoxTag, "box", 1, WriteBox},
    {PairTag, "pair", 2, WritePair},
    {StringTag, "string", 0, WriteStringObject},
    {CStringTag, "cstring", 0, WriteCStringObject},
    {VectorTag, "vector", MAXIMUM_ULONG, WriteVector},
    ...
    {ExclusiveTag, "exclusive", 2, WriteExclusive},
    {ConditionTag, "condition", 2, WriteCondition},
...
long_t SetupFoment(FThreadState * ts)
{
    ...
    FAssert(ObjectTypes[FreeTag].SlotCount == 0);
    ...
    RegisterRoot(&MakeObjectOutOfMemory, "make-object-out-of-memory");
    RegisterRoot(&CollectOutOfMemory, "collect-out-of-memory");
    RegisterRoot(&StartThreadOutOfMemory, "start-thread-out-of-memory");
    RegisterRoot(&ExecuteStackOverflow, "execute-stack-overflow");
