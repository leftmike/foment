...
{
    {0, 0},
    {"bignum", 0, WriteNumber},
    {"ratio", 2, WriteNumber},
    {"complex", 2, WriteNumber},
    {"flonum", 0, WriteNumber},
    {"box", 1, WriteBox},
    {"pair", 2, WritePair},
    {"string", 0, WriteStringObject},
    {"cstring", 0, WriteCStringObject},
    {"vector", MAXIMUM_ULONG, WriteVector},
    {"bytevector", 0, WriteBytevector},
    {"binary-port", 2, WritePortObject},
    {"textual-port", 2, WritePortObject},
    {"procedure", 4, WriteProcedure},
    {"symbol", 1, WriteSymbol},
    {"identifier", 4, WriteIdentifier},
    {"record-type", MAXIMUM_ULONG, WriteRecordType},
    {"record", MAXIMUM_ULONG, WriteRecord},
    {"primitive", 1, WritePrimitive},
    {"thread", 4, WriteThread},
    {"exclusive", 0, WriteExclusive},
    {"condition", 0, WriteCondition},
    {"hash-node", 3, WriteHashNode},
    {"hash-table", 5, WriteHashTable},
    {"ephemeron", 0, WriteEphemeron},
    {"char-set", 0, WriteCharSet},
    {"subprocess", 0, WriteSubprocess},
    {"exception", 5, WriteException},
    {"dynamic", 4, 0},
    {"continuation", 4, 0},
    {"custom-port", 7, 0},
    {"codec", 0, WriteCodec},
    {"transcoder", 1, WriteTranscoder},
    {"datum-reference", 1, 0},
    {"environment", 4, WriteEnvironment},
    {"global", 5, WriteGlobal},
    {"library", 2, WriteLibrary},
    {"comparator", 5, 0},
    {"syntactic-environment", 2, 0},
    {"binding", 10, 0},
    {"reference", 2, 0},
    {"lambda", 15, WriteLambda},
    {"case-lambda", 3, 0},
    {"syntax-rules", 3, 0},
    {"pattern-variable", 3, 0},
    {"pattern-repeat", 5, 0},
    {"template-repeat", 5, 0},
    {"syntax-rule", 4, 0},
    {"free", 0, 0}
