...
int ListLength(FObject obj)
{
    ...
    while (obj != EmptyListObject)
    {
        if (PairP(obj))
        {
            ...
            RaiseExceptionC(Assertion, "list-length", "list-length: not a proper list",
                    List(list));
    }
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "pair?", "pair?: expected one argument", EmptyListObject);
...
{
    if (argc != 2)
        RaiseExceptionC(Assertion, "cons", "cons: expected two arguments", EmptyListObject);
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "car", "car: expected one argument", EmptyListObject);

    if (PairP(argv[0]) == 0)
        RaiseExceptionC(Assertion, "car", "car: expected a pair", List(argv[0]));
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "cdr", "cdr: expected one argument", EmptyListObject);

    if (PairP(argv[0]) == 0)
        RaiseExceptionC(Assertion, "cdr", "cdr: expected a pair", List(argv[0]));
...
{
    if (argc != 2)
        RaiseExceptionC(Assertion, "set-car!", "set-car!: expected two arguments",
                EmptyListObject);
...
{
    if (argc != 2)
        RaiseExceptionC(Assertion, "set-cdr!", "set-cdr!: expected two arguments",
                EmptyListObject);

    if (PairP(argv[0]) == 0)
        RaiseExceptionC(Assertion, "set-cdr!", "set-cdr!: expected a pair", List(argv[0]));
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "null?", "null?: expected one argument", EmptyListObject);
...
static FObject ReverseList(FObject list)
{
    ...
    {
        if (PairP(lst) == 0)
            RaiseExceptionC(Assertion, "reverse", "reverse: expected a proper list", List(list));
...
{
    if (argc < 1)
        RaiseExceptionC(Assertion, "append", "append: expected at least one argument",
                EmptyListObject);
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "reverse", "reverse: expected one argument", EmptyListObject);
...
{
    if (argc != 2)
        RaiseExceptionC(Assertion, "list-ref", "list-ref: expected two arguments",
                EmptyListObject);

    if (FixnumP(argv[1]) == 0)
        RaiseExceptionC(Assertion, "list-ref", "list-ref: expected a fixnum", List(argv[1]));
    ...
    {
        if (PairP(lst) == 0)
            RaiseExceptionC(Assertion, "list-ref", "list-ref: expected a list", List(argv[0]));
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "map-car", "map-car: expected one argument", EmptyListObject);
...
{
    if (argc != 1)
        RaiseExceptionC(Assertion, "map-cdr", "map-cdr: expected one argument", EmptyListObject);
